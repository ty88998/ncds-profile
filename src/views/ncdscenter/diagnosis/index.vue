<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:diagnosis:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:diagnosis:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="diagnosisList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="疾病" align="center" prop="id" />
...
<script>
import { listDiagnosis, getDiagnosis, delDiagnosis, addDiagnosis, updateDiagnosis } from "@/api/ncds/diagnosis";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/diagnosis/export', {
        ...this.queryParams
      }, `system_diagnosis.xlsx`)
    }
  }
};
</script>