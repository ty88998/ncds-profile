...
const tools = {
    ...
    saveBpmn(bpmnModeler) {
        bpmnModeler.saveXML({ format: true }, function (err, xml) {
            ...
            $.ajax({
                url: localStorage.getItem("VUE_APP_BASE_API")+'/ncdscenter/processDefinition/addDeploymentByString',
                type: 'POST',
                dataType:"json",
                data: param,
    ...
    upload(bpmnModeler, container) {
        ...
        $.ajax({
            url: localStorage.getItem("VUE_APP_BASE_API")+'/ncdscenter/processDefinition/upload',
